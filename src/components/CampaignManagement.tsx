...
import { Copy, ChevronRight, Warehouse, Plus } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="bg-white border border-zinc-200 shadow-sm flex flex-col">
        <div className="grid grid-cols-12 gap-4 px-8 py-4 border-b border-zinc-200 bg-zinc-50 text-[10px] font-bold text-zinc-500 uppercase tracking-widest">
          <div className="col-span-6">货单详情 (ID / 名称 / 仓库)</div>
