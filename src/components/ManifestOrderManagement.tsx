    ...
    <div className="max-w-7xl mx-auto flex h-[calc(100vh-80px)]">
      <div className="flex-1 overflow-y-auto">
        <div className="flex justify-between items-end mb-8">
          <div>
            ...
            <h1 className="text-3xl font-black tracking-tighter uppercase mb-2">货单订单管理</h1>
            <p className="text-sm text-zinc-500">管理货单业务订单，支持手工确认银行转账付款</p>
          </div>
        </div>
                ...
                <div className="col-span-1 text-right flex items-center justify-end gap-2">
                  {order.status === 'pending_refund' && (
                    <button 
                      ...
                      className="text-xs font-bold text-red-600 hover:text-red-800 border border-red-200 px-2 py-1 bg-red-50"
                    >
                      退款
                    </button>
                  )}
            ...
            <div className="flex gap-3">
              {selectedOrderData.status === 'pending_deposit' && (
                <button 
                  ...
                  className="bg-black text-white px-6 py-2 text-xs font-bold uppercase tracking-widest hover:bg-zinc-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                >
                  <CheckCircle size={14} />
                  确认已付定金
                </button>
              ...
              {selectedOrderData.status === 'pending_confirmation' && (
                <>
                  <button 
                    ...
                    className="bg-white border border-zinc-200 text-red-600 px-6 py-2 text-xs font-bold uppercase tracking-widest hover:border-red-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    提交退款 (缺货)
                  </button>
                  <button 
                    ...
                    className="bg-black text-white px-6 py-2 text-xs font-bold uppercase tracking-widest hover:bg-zinc-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    确认有货
                  </button>
                </>
              ...
              {selectedOrderData.status === 'pending_final_payment' && (
                <button 
                  ...
                  className="bg-black text-white px-6 py-2 text-xs font-bold uppercase tracking-widest hover:bg-zinc-800 transition-colors flex items-center gap-2"
                >
                  <CheckCircle size={14} />
                  确认已付尾款
                </button>
              ...
              {selectedOrderData.status === 'pending_refund' && (
                <button 
                  ...
                  className="bg-red-600 text-white px-6 py-2 text-xs font-bold uppercase tracking-widest hover:bg-red-700 transition-colors flex items-center gap-2"
                >
                  确认退款完成
                </button>
              )}
      ...
      {isShippingModalOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white w-[500px] shadow-2xl animate-in fade-in zoom-in-95 duration-200">
